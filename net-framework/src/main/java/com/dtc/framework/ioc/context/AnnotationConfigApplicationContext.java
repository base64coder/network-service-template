...
import com.dtc.framework.ioc.annotation.*;
import com.dtc.framework.ioc.core.BeanDefinition;
import com.dtc.framework.ioc.event.ContextClosedEvent;
import com.dtc.framework.ioc.event.ContextRefreshedEvent;
import com.dtc.framework.ioc.event.SimpleEventMulticaster;
import com.dtc.framework.ioc.exception.BeansException;
import com.dtc.framework.ioc.factory.BeanPostProcessor;
import com.dtc.framework.ioc.factory.DefaultListableBeanFactory;
import com.dtc.framework.ioc.support.ClassScanner;
    ...
    private void registerEventListeners() {
        ...
        for (String beanName : beanNames) {
            ...
            if (bd != null && bd.getBeanClass() != null) {
                ...
                if (com.dtc.framework.ioc.event.ApplicationListener.class.isAssignableFrom(bd.getBeanClass())) {
                    try {
                        Object listener = beanFactory.getBean(beanName);
                        eventMulticaster.addListener((com.dtc.framework.ioc.event.ApplicationListener<?>) listener);
                    } catch (Exception e) {
