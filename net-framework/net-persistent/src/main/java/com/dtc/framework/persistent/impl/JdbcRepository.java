...
public class JdbcRepository<T, ID> implements BaseRepository<T, ID> {
    ...
    private final com.dtc.framework.persistent.dialect.Dialect dialect;
    private final boolean isAutoGeneratedKey;
    ...
    public JdbcRepository(DataSource dataSource) {
        ...
        try {
            ...
            this.dialect = com.dtc.framework.persistent.dialect.DialectFactory.getDialect(conn);
        ...
        if (primaryKeyField != null) {
            ...
            this.isAutoGeneratedKey = idAnnotation != null && idAnnotation.keyType() == Id.KeyType.AUTO;
        } else {
    ...
    public T insert(@NotNull T entity) {
        ...
        try {
            ...
            try (PreparedStatement stmt = conn.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
                ...
                // 处理自动生成的主键
                // 如果标记为自动生成，或者主键值为null，则尝试获取生成的主键
                if (isAutoGeneratedKey() || getPrimaryKeyValue(entity) == null) {
                    ...
                    if (isAutoGeneratedKey() && !keyFound) {
                        throw new RuntimeException("Failed to generate primary key for entity " + entityClass.getSimpleName());
                    }
                }
    ...
    private T updateEntity(@NotNull T entity) {
        ...
        try {
            ...
            try (PreparedStatement stmt = conn.prepareStatement(sql)) {
                ...
                int rows = stmt.executeUpdate();
                if (rows == 0) {
                    throw new RuntimeException("Failed to update entity: No rows affected. Entity might not exist.");
                }
        ...
        try {
            ...
            for (Map.Entry<String, String> entry : fieldColumnMapping.entrySet()) {
                ...
                try {
                    ...
                    // Ignore if column not found (optional safety)
                    // Or log warning
                }
            }
