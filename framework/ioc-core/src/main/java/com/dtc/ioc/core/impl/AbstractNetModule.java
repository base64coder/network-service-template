...
public abstract class AbstractNetModule implements NetModule {
     ...
     */
    protected <T> void bind(NetApplicationContext context, 
     ...
     * @param implementationClass 实现类
     */
    protected void bind(NetApplicationContext context, 
                       String name, 
     ...
     * @param instance 实例
     */
    protected void bindInstance(NetApplicationContext context, 
                               String name, 
                               Object instance) {
     ...
     * @param instance 实例
     */
    protected <T> void bindInstance(NetApplicationContext context, 
                                   Class<T> interfaceClass, 
                                   T instance) {
