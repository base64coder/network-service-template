...
public class StartupBanner {
    ...
    public void displayBanner() {
        ...
        log.info("Network Service Template - 基于扩展的网络服务框架");
    }
    ...
    public void displayServerInfo() {
        ...
        System.out.printf("📁 数据文件夹: %s%n", configuration.getDataFolder().toAbsolutePath());
        System.out.printf("⚙️  配置文件: %s%n", configuration.getConfigFolder().toAbsolutePath());
        System.out.printf("🔌 扩展文件夹: %s%n", configuration.getExtensionsFolder().toAbsolutePath());
    ...
    public void displaySystemInfo() {
        ...
        System.out.printf("🏢 Java厂商: %s%n", System.getProperty("java.vendor"));
    ...
    public void displayStartupComplete() {
        ...
        System.out.println("🌟 网络服务框架已就绪，正在监听...");
        System.out.println("📊 通过日志查看详细信息和监控数据");
